...
export default function About() {
  ...
  return (
    <section id="about" style={{ background:C.paper, padding:"clamp(80px,11vh,140px) clamp(20px,5vw,72px)", position:"relative", overflow:"hidden" }}>
      {/* Rotated watermark */}
      <div style={{ position:"absolute", right:-40, top:"50%", transform:"translateY(-50%) rotate(90deg)", fontFamily:C.serif, fontSize:"clamp(80px,14vw,180px)", fontWeight:300, color:`${C.ghost}80`, letterSpacing:8, userSelect:"none", pointerEvents:"none", whiteSpace:"nowrap" }}>
        DEVELOPER
      </div>

      <div style={{ maxWidth:1320, margin:"0 auto", position:"relative" }}>
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"clamp(40px,7vw,120px)", alignItems:"center" }} className="about-grid">
